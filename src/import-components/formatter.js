...
export class Formatter extends Component {
  ...
  openTextArea = e => {
    ...
    d3.select("#punc").property(
      "value",
      this.state.sep[this.state.menu.element]
    );
  ...
  render() {
    return (
      <div id="format" className="format">
        <p className="instr">
          Drag and drop the order of each line in your file.
        </p>
        <DragDropContext
        ...
        <div className="ex">
          <span className="paper">
            ...
            <i>
              {this.state.items[0].ex +
                this.state.sep[0] +
                this.state.items[1].ex +
                this.state.sep[1] +
                this.state.items[2].ex}
            </i>
            <i>
              {this.state.items[0].ex +
                this.state.sep[0] +
